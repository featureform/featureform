...
class Registrar:
    ...
    def register_column_resources(
        ...
        for feature in features:
            ...
            feature_description = feature["description"] if "description" in feature else feature_description = ""
            resource = Feature(
                name=feature["name"],
                variant=variant,
                source=source,
        ...
        for label in labels:
            ...
            label_description = label["description"] if "description" in label else label_description = ""
            resource = Label(
                name=label["name"],
                variant=variant,
                source=source,
