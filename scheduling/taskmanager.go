...
/*
This format is really weird. What I'd ideally like is a templated string that we can plug values into but text/templates
feels overly complicated. Can settle for having just a function that returns the formatted string but would prefer to
be able to read it easily. Also want to create a top level directory called schema that has tests for formatting in it.
*/
