---
title: "Pinecone"
description: "Featureform supports [Pinecone](https://pinecone.io/) as a [Vector DB](/providers/vector-db)."
---
...
Once our config file is complete, we can apply it to our Featureform deployment. Afterwards we can set it as the [Vector DB](/providers/vector-db) when defining an [embedding](/abstractions/embedding).
