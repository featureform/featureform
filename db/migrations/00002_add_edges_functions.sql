...
CREATE FUNCTION insert_edge(from_type integer, from_name text, from_variant text, to_type integer, to_name text,
                            to_variant text) RETURNS void
    LANGUAGE plpgsql
AS
$$
BEGIN
