---
title: "Building a Chatbot with OpenAI and a Vector Database"
---
...
<Frame caption="RAG workflow explained">
  <img src="/images/llms-embeddings-and-vector-databases/rag-workflow-explained.png" />
</Frame>
...
#### HuggingFace sentence\_transformers

sentence\_transformers with HuggingFace is our recommended way of embedding models. It’s fast and free! The quality of embeddings will likely be slightly worse than ADAs though.
...
We can tell and LLM how to format: Answer the following questions with five bullet points.
