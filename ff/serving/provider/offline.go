...
type OfflineStore interface {
	...
	RegisterStatFromResourceTable(id ResourceID, schema ResourceSchema) error
	Provider
}
...
func (store *memoryOfflineStore) RegisterStatFromResourceTable(id ResourceID, schema ResourceSchema) error {
	return fmt.Errorf("Snowflake RegisterResourceFromSourceTable not implemented")
}
