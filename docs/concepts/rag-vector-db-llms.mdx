...
description: "Large Language Models (LLMs) are pre-trained models that take a text prompt as input and generate a response based on the prompt."
---
...
Check out our [deep-dive into retrieval augmented generation](../embeddings/building-a-chatbot-with-openai-and-a-vector-database)!
