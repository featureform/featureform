...
CREATE FUNCTION add_edge_from_ff_task_metadata(key TEXT, value TEXT) RETURNS VOID
    LANGUAGE plpgsql
AS
$$
BEGIN
...
CREATE FUNCTION create_edges_from_ff_task_metadata() RETURNS VOID
    LANGUAGE plpgsql
AS
$$
DECLARE
...
CREATE FUNCTION trigger_add_edge_from_ff_task_metadata() RETURNS TRIGGER
    LANGUAGE plpgsql
AS
$$
BEGIN
