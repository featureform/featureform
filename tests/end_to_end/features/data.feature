Feature: Data within Featureform
  Scenario Outline: Registering a feature and training set with different data types
    ...
    Examples: Spark Data Types with Redis
      ...
      | redis                | spark                 | s3://featureform-spark-testing/datasets/data_types_dataset.csv | int_col        | int          | username      | datetime_col     | boolean_col  | wiseposition  | -21524                                                                        | int           |
      | redis                | spark                 | s3://featureform-spark-testing/datasets/data_types_dataset.csv | int32_col      | int32        | username      | datetime_col     | boolean_col  | maturesound   | 1671621217                                                                   | int32         |
      | redis                | spark                 | s3://featureform-spark-testing/datasets/data_types_dataset.csv | int64_col      | int64        | username      | datetime_col     | boolean_col  | richexistence | 1136335578646221838                                                           | int64         |
      | redis                | spark                 | s3://featureform-spark-testing/datasets/data_types_dataset.csv | float32_col    | float32      | username      | datetime_col     | boolean_col  | woozyjar      | 2.4922891928141537e-39                                                          | float32       |
      | redis                | spark                 | s3://featureform-spark-testing/datasets/data_types_dataset.csv | float64_col    | float64      | username      | datetime_col     | boolean_col  | dynamictrip   | 1.80046184076813e+198                                                         | float64       |
      | redis                | spark                 | s3://featureform-spark-testing/datasets/data_types_dataset.csv | string_col     | string       | username      | datetime_col     | boolean_col  | triteframe    | In sed lacus ac mi placerat congue | string        |
