...
class SQLiteTest:
    ...
    def createTables(self):
        ...
        conn.execute(
            """INSERT INTO feature_variant VALUES 
        ...
        conn.execute(
            """CREATE TABLE training_set_variant(
            created text,
            description text,            
        ...
        conn.execute(
            """INSERT INTO training_set_variant VALUES
       ...
       """
        ...
        conn.execute(
            """INSERT INTO training_sets VALUES
       ...
       """
        ...
        conn.execute(
            """INSERT INTO label_variant VALUES
    ...
    def get_variant_resource(self, type, variable, resource):
        variant_table_query = (
            "SELECT * FROM " + type + " WHERE " + variable + "='" + resource + "';"
        )
