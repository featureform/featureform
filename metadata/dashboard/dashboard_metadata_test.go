...
//	getID := func(id uint64) sc.TaskID {
//		orderedID := ffsync.Uint64OrderedId(id)
//		return sc.TaskID(&orderedID)
//	}
//	taskMetadataStaticList = []sc.TaskMetadata{
//		{ID: getID(0), Name: "Test_job", TaskType: sc.ResourceCreation, Target: sc.NameVariant{
//			Name:    "transaction",
//			Variant: "default",
//		}, TargetType: sc.NameVariantTarget, DateCreated: time.Now().Truncate(0).UTC()},
//		{ID: getID(1), Name: "Nicole_Puppers", TaskType: sc.Monitoring, Target: sc.NameVariant{
//			Name:    "avg_transactions",
//			Variant: "v1",
//		}, TargetType: sc.NameVariantTarget, DateCreated: time.Now().Truncate(0).UTC()},
//		{ID: getID(2), Name: "Sandbox_Test", TaskType: sc.ResourceCreation, Target: sc.NameVariant{
//			Name:    "transaction",
//			Variant: "default",
//		}, TargetType: sc.NameVariantTarget, DateCreated: time.Now().Truncate(0).UTC()},
//		{ID: getID(3), Name: "Production_Data_Set", TaskType: sc.HealthCheck, Target: sc.NameVariant{
//			Name:    "speed_dating",
//			Variant: "left_overs",
//		}, TargetType: sc.NameVariantTarget, DateCreated: time.Now().Truncate(0).UTC()},
//		{ID: getID(4), Name: "MySQL Task", TaskType: sc.ResourceCreation, Target: sc.NameVariant{
//			Name:    "testing_name",
...
//		ID:          sc.TaskRunID(&orderedID),
//		TaskId:      foundTaskMetadata.ID,
//		Name:        foundTaskMetadata.Name,
//		Trigger:     sc.OnApplyTrigger{TriggerName: "Apply"},
//		TriggerType: sc.OnApplyTriggerType,
//		Status:      status,
