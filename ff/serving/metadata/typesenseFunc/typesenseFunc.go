...
func (s Search) Search(searchParameters *api.SearchCollectionParams) (*api.SearchResult, error) {
	results, err2 := s.Client.Collection("feat").Documents().Search(searchParameters)
	if err2 != nil {
		return nil, err2
	}
	return results, nil
