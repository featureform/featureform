...
test_e2e: update_python					## Runs End-to-End tests on minikube
	...
	pytest -v client/tests/e2e.py
	pytest -v -m 'hosted' client/tests/test_serving_model.py
	pytest -v -m 'hosted' client/tests/test_getting_model.py
	pytest -v -m 'hosted' client/tests/test_updating_provider.py
	pytest -v -m 'hosted' client/tests/test_class_api.py
	pytest -v -m 'hosted' client/tests/test_source_dataframe.py
	pytest -v -m 'hosted' client/tests/test_training_set_dataframe.py
