...
func (h *Health) IsSupportedProvider(t pt.Type) bool {
	switch t {
	case pt.RedisOnline, pt.DynamoDBOnline, pt.InlinedKVOnline, pt.PostgresOffline, pt.SnowflakeOffline, pt.ClickHouseOffline, pt.SparkOffline, pt.RedshiftOffline:
		return true
	default:
		return false
	}
