...
type ApiClient interface {
	...
	CreateLabelVariant(ctx context.Context, in *LabelVariant, opts ...grpc.CallOption) (*Empty, error)
	CreateTrainingSetVariant(ctx context.Context, in *TrainingSetVariant, opts ...grpc.CallOption) (*Empty, error)
	GetUsers(ctx context.Context, opts ...grpc.CallOption) (Api_GetUsersClient, error)
	GetFeatures(ctx context.Context, opts ...grpc.CallOption) (Api_GetFeaturesClient, error)
	GetFeatureVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetFeatureVariantsClient, error)
	GetLabels(ctx context.Context, opts ...grpc.CallOption) (Api_GetLabelsClient, error)
	GetLabelVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetLabelVariantsClient, error)
	GetTrainingSets(ctx context.Context, opts ...grpc.CallOption) (Api_GetTrainingSetsClient, error)
	GetTrainingSetVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetTrainingSetVariantsClient, error)
	GetSources(ctx context.Context, opts ...grpc.CallOption) (Api_GetSourcesClient, error)
	GetSourceVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetSourceVariantsClient, error)
...
func (c *apiClient) GetUsers(ctx context.Context, opts ...grpc.CallOption) (Api_GetUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[0], "/featureform.serving.metadata.proto.Api/GetUsers", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetUsersClient{stream}
	return x, nil
}

type Api_GetUsersClient interface {
	Send(*Name) error
	Recv() (*User, error)
	grpc.ClientStream
}

type apiGetUsersClient struct {
	grpc.ClientStream
}

func (x *apiGetUsersClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetUsersClient) Recv() (*User, error) {
	m := new(User)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetFeatures(ctx context.Context, opts ...grpc.CallOption) (Api_GetFeaturesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[1], "/featureform.serving.metadata.proto.Api/GetFeatures", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetFeaturesClient{stream}
	return x, nil
}

type Api_GetFeaturesClient interface {
	Send(*Name) error
	Recv() (*Feature, error)
	grpc.ClientStream
}

type apiGetFeaturesClient struct {
	grpc.ClientStream
}

func (x *apiGetFeaturesClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetFeaturesClient) Recv() (*Feature, error) {
	m := new(Feature)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetFeatureVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetFeatureVariantsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[2], "/featureform.serving.metadata.proto.Api/GetFeatureVariants", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetFeatureVariantsClient{stream}
	return x, nil
}

type Api_GetFeatureVariantsClient interface {
	Send(*NameVariant) error
	Recv() (*FeatureVariant, error)
	grpc.ClientStream
}

type apiGetFeatureVariantsClient struct {
	grpc.ClientStream
}

func (x *apiGetFeatureVariantsClient) Send(m *NameVariant) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetFeatureVariantsClient) Recv() (*FeatureVariant, error) {
	m := new(FeatureVariant)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetLabels(ctx context.Context, opts ...grpc.CallOption) (Api_GetLabelsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[3], "/featureform.serving.metadata.proto.Api/GetLabels", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetLabelsClient{stream}
	return x, nil
}

type Api_GetLabelsClient interface {
	Send(*Name) error
	Recv() (*Label, error)
	grpc.ClientStream
}

type apiGetLabelsClient struct {
	grpc.ClientStream
}

func (x *apiGetLabelsClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetLabelsClient) Recv() (*Label, error) {
	m := new(Label)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetLabelVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetLabelVariantsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[4], "/featureform.serving.metadata.proto.Api/GetLabelVariants", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetLabelVariantsClient{stream}
	return x, nil
}

type Api_GetLabelVariantsClient interface {
	Send(*NameVariant) error
	Recv() (*LabelVariant, error)
	grpc.ClientStream
}

type apiGetLabelVariantsClient struct {
	grpc.ClientStream
}

func (x *apiGetLabelVariantsClient) Send(m *NameVariant) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetLabelVariantsClient) Recv() (*LabelVariant, error) {
	m := new(LabelVariant)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetTrainingSets(ctx context.Context, opts ...grpc.CallOption) (Api_GetTrainingSetsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[5], "/featureform.serving.metadata.proto.Api/GetTrainingSets", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetTrainingSetsClient{stream}
	return x, nil
}

type Api_GetTrainingSetsClient interface {
	Send(*Name) error
	Recv() (*TrainingSet, error)
	grpc.ClientStream
}

type apiGetTrainingSetsClient struct {
	grpc.ClientStream
}

func (x *apiGetTrainingSetsClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetTrainingSetsClient) Recv() (*TrainingSet, error) {
	m := new(TrainingSet)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetTrainingSetVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetTrainingSetVariantsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[6], "/featureform.serving.metadata.proto.Api/GetTrainingSetVariants", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetTrainingSetVariantsClient{stream}
	return x, nil
}

type Api_GetTrainingSetVariantsClient interface {
	Send(*NameVariant) error
	Recv() (*TrainingSetVariant, error)
	grpc.ClientStream
}

type apiGetTrainingSetVariantsClient struct {
	grpc.ClientStream
}

func (x *apiGetTrainingSetVariantsClient) Send(m *NameVariant) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetTrainingSetVariantsClient) Recv() (*TrainingSetVariant, error) {
	m := new(TrainingSetVariant)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetSources(ctx context.Context, opts ...grpc.CallOption) (Api_GetSourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[7], "/featureform.serving.metadata.proto.Api/GetSources", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetSourcesClient{stream}
	return x, nil
}

type Api_GetSourcesClient interface {
	Send(*Name) error
	Recv() (*Source, error)
	grpc.ClientStream
}

type apiGetSourcesClient struct {
	grpc.ClientStream
}

func (x *apiGetSourcesClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetSourcesClient) Recv() (*Source, error) {
	m := new(Source)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetSourceVariants(ctx context.Context, opts ...grpc.CallOption) (Api_GetSourceVariantsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[8], "/featureform.serving.metadata.proto.Api/GetSourceVariants", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetSourceVariantsClient{stream}
	return x, nil
}

type Api_GetSourceVariantsClient interface {
	Send(*NameVariant) error
	Recv() (*SourceVariant, error)
	grpc.ClientStream
}

type apiGetSourceVariantsClient struct {
	grpc.ClientStream
}

func (x *apiGetSourceVariantsClient) Send(m *NameVariant) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetSourceVariantsClient) Recv() (*SourceVariant, error) {
	m := new(SourceVariant)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetProviders(ctx context.Context, opts ...grpc.CallOption) (Api_GetProvidersClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[9], "/featureform.serving.metadata.proto.Api/GetProviders", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetProvidersClient{stream}
	return x, nil
}

type Api_GetProvidersClient interface {
	Send(*Name) error
	Recv() (*Provider, error)
	grpc.ClientStream
}

type apiGetProvidersClient struct {
	grpc.ClientStream
}

func (x *apiGetProvidersClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetProvidersClient) Recv() (*Provider, error) {
	m := new(Provider)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetEntities(ctx context.Context, opts ...grpc.CallOption) (Api_GetEntitiesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[10], "/featureform.serving.metadata.proto.Api/GetEntities", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetEntitiesClient{stream}
	return x, nil
}

type Api_GetEntitiesClient interface {
	Send(*Name) error
	Recv() (*Entity, error)
	grpc.ClientStream
}

type apiGetEntitiesClient struct {
	grpc.ClientStream
}

func (x *apiGetEntitiesClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetEntitiesClient) Recv() (*Entity, error) {
	m := new(Entity)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *apiClient) GetModels(ctx context.Context, opts ...grpc.CallOption) (Api_GetModelsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Api_ServiceDesc.Streams[11], "/featureform.serving.metadata.proto.Api/GetModels", opts...)
	if err != nil {
		return nil, err
	}
	x := &apiGetModelsClient{stream}
	return x, nil
}

type Api_GetModelsClient interface {
	Send(*Name) error
	Recv() (*Model, error)
	grpc.ClientStream
}

type apiGetModelsClient struct {
	grpc.ClientStream
}

func (x *apiGetModelsClient) Send(m *Name) error {
	return x.ClientStream.SendMsg(m)
}

func (x *apiGetModelsClient) Recv() (*Model, error) {
	m := new(Model)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type ApiServer interface {
	...
	CreateLabelVariant(context.Context, *LabelVariant) (*Empty, error)
	CreateTrainingSetVariant(context.Context, *TrainingSetVariant) (*Empty, error)
	GetUsers(Api_GetUsersServer) error
	GetFeatures(Api_GetFeaturesServer) error
	GetFeatureVariants(Api_GetFeatureVariantsServer) error
	GetLabels(Api_GetLabelsServer) error
	GetLabelVariants(Api_GetLabelVariantsServer) error
	GetTrainingSets(Api_GetTrainingSetsServer) error
	GetTrainingSetVariants(Api_GetTrainingSetVariantsServer) error
	GetSources(Api_GetSourcesServer) error
	GetSourceVariants(Api_GetSourceVariantsServer) error
...
func (UnimplementedApiServer) GetUsers(Api_GetUsersServer) error {
	return status.Errorf(codes.Unimplemented, "method GetUsers not implemented")
}
func (UnimplementedApiServer) GetFeatures(Api_GetFeaturesServer) error {
	return status.Errorf(codes.Unimplemented, "method GetFeatures not implemented")
}
func (UnimplementedApiServer) GetFeatureVariants(Api_GetFeatureVariantsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetFeatureVariants not implemented")
}
func (UnimplementedApiServer) GetLabels(Api_GetLabelsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetLabels not implemented")
}
func (UnimplementedApiServer) GetLabelVariants(Api_GetLabelVariantsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetLabelVariants not implemented")
}
func (UnimplementedApiServer) GetTrainingSets(Api_GetTrainingSetsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetTrainingSets not implemented")
}
func (UnimplementedApiServer) GetTrainingSetVariants(Api_GetTrainingSetVariantsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetTrainingSetVariants not implemented")
}
func (UnimplementedApiServer) GetSources(Api_GetSourcesServer) error {
	return status.Errorf(codes.Unimplemented, "method GetSources not implemented")
}
func (UnimplementedApiServer) GetSourceVariants(Api_GetSourceVariantsServer) error {
	return status.Errorf(codes.Unimplemented, "method GetSourceVariants not implemented")
}
func (UnimplementedApiServer) GetProviders(Api_GetProvidersServer) error {
	return status.Errorf(codes.Unimplemented, "method GetProviders not implemented")
}
func (UnimplementedApiServer) GetEntities(Api_GetEntitiesServer) error {
	return status.Errorf(codes.Unimplemented, "method GetEntities not implemented")
}
...
func _Api_GetUsers_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetUsers(&apiGetUsersServer{stream})
}

type Api_GetUsersServer interface {
	Send(*User) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetUsersServer struct {
	grpc.ServerStream
}

func (x *apiGetUsersServer) Send(m *User) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetUsersServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetFeatures_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetFeatures(&apiGetFeaturesServer{stream})
}

type Api_GetFeaturesServer interface {
	Send(*Feature) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetFeaturesServer struct {
	grpc.ServerStream
}

func (x *apiGetFeaturesServer) Send(m *Feature) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetFeaturesServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetFeatureVariants_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetFeatureVariants(&apiGetFeatureVariantsServer{stream})
}

type Api_GetFeatureVariantsServer interface {
	Send(*FeatureVariant) error
	Recv() (*NameVariant, error)
	grpc.ServerStream
}

type apiGetFeatureVariantsServer struct {
	grpc.ServerStream
}

func (x *apiGetFeatureVariantsServer) Send(m *FeatureVariant) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetFeatureVariantsServer) Recv() (*NameVariant, error) {
	m := new(NameVariant)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetLabels_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetLabels(&apiGetLabelsServer{stream})
}

type Api_GetLabelsServer interface {
	Send(*Label) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetLabelsServer struct {
	grpc.ServerStream
}

func (x *apiGetLabelsServer) Send(m *Label) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetLabelsServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetLabelVariants_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetLabelVariants(&apiGetLabelVariantsServer{stream})
}

type Api_GetLabelVariantsServer interface {
	Send(*LabelVariant) error
	Recv() (*NameVariant, error)
	grpc.ServerStream
}

type apiGetLabelVariantsServer struct {
	grpc.ServerStream
}

func (x *apiGetLabelVariantsServer) Send(m *LabelVariant) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetLabelVariantsServer) Recv() (*NameVariant, error) {
	m := new(NameVariant)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetTrainingSets_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetTrainingSets(&apiGetTrainingSetsServer{stream})
}

type Api_GetTrainingSetsServer interface {
	Send(*TrainingSet) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetTrainingSetsServer struct {
	grpc.ServerStream
}

func (x *apiGetTrainingSetsServer) Send(m *TrainingSet) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetTrainingSetsServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetTrainingSetVariants_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetTrainingSetVariants(&apiGetTrainingSetVariantsServer{stream})
}

type Api_GetTrainingSetVariantsServer interface {
	Send(*TrainingSetVariant) error
	Recv() (*NameVariant, error)
	grpc.ServerStream
}

type apiGetTrainingSetVariantsServer struct {
	grpc.ServerStream
}

func (x *apiGetTrainingSetVariantsServer) Send(m *TrainingSetVariant) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetTrainingSetVariantsServer) Recv() (*NameVariant, error) {
	m := new(NameVariant)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetSources_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetSources(&apiGetSourcesServer{stream})
}

type Api_GetSourcesServer interface {
	Send(*Source) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetSourcesServer struct {
	grpc.ServerStream
}

func (x *apiGetSourcesServer) Send(m *Source) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetSourcesServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetSourceVariants_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetSourceVariants(&apiGetSourceVariantsServer{stream})
}

type Api_GetSourceVariantsServer interface {
	Send(*SourceVariant) error
	Recv() (*NameVariant, error)
	grpc.ServerStream
}

type apiGetSourceVariantsServer struct {
	grpc.ServerStream
}

func (x *apiGetSourceVariantsServer) Send(m *SourceVariant) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetSourceVariantsServer) Recv() (*NameVariant, error) {
	m := new(NameVariant)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetProviders_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetProviders(&apiGetProvidersServer{stream})
}

type Api_GetProvidersServer interface {
	Send(*Provider) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetProvidersServer struct {
	grpc.ServerStream
}

func (x *apiGetProvidersServer) Send(m *Provider) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetProvidersServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetEntities_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetEntities(&apiGetEntitiesServer{stream})
}

type Api_GetEntitiesServer interface {
	Send(*Entity) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetEntitiesServer struct {
	grpc.ServerStream
}

func (x *apiGetEntitiesServer) Send(m *Entity) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetEntitiesServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Api_GetModels_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ApiServer).GetModels(&apiGetModelsServer{stream})
}

type Api_GetModelsServer interface {
	Send(*Model) error
	Recv() (*Name, error)
	grpc.ServerStream
}

type apiGetModelsServer struct {
	grpc.ServerStream
}

func (x *apiGetModelsServer) Send(m *Model) error {
	return x.ServerStream.SendMsg(m)
}

func (x *apiGetModelsServer) Recv() (*Name, error) {
	m := new(Name)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var Api_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetFeatures",
			Handler:       _Api_GetFeatures_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetFeatureVariants",
			Handler:       _Api_GetFeatureVariants_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetLabels",
			Handler:       _Api_GetLabels_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetLabelVariants",
			Handler:       _Api_GetLabelVariants_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetTrainingSets",
			Handler:       _Api_GetTrainingSets_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetTrainingSetVariants",
			Handler:       _Api_GetTrainingSetVariants_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
		...
		{
			StreamName:    "GetSourceVariants",
			Handler:       _Api_GetSourceVariants_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetProviders",
			Handler:       _Api_GetProviders_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
			StreamName:    "GetEntities",
			Handler:       _Api_GetEntities_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
		{
