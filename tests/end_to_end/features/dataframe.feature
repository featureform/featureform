Feature: Serving Pandas Dataframe with client.dataframe method 
  Scenario Outline: Getting the Dataframe of a Transformation
    ...
    Examples: Spark
      | offline_provider_type |                    dataset_path                       | transformation_type | limit |
      |         spark         | s3a://featureform-spark-testing/data/transactions.csv |         df          |   0   |
      |         spark         | s3a://featureform-spark-testing/data/transactions.csv |         df          |   1   |
      |         spark         | s3a://featureform-spark-testing/data/transactions.csv |         df          |  none |
