...
**Open-source** [Featureform](https://github.com/featureform/featureform) is free to use under the MPL 2.0 license. Use [quickstart guide](https://featureform-docs.mintlify.app/deployment/quickstart) to test out the Featureform API in Local Mode.
